...
import './App.css';
import DisplayName from './Greetings'
import CharacterGallery from "./CharacterGallery";


function App() {

  //const names: string[] = ["Mathias", "Ulli", "Max"];<header className="App-header"></header>
    //         <header> Duebeltaeter </header>
    //         <DisplayName names={names}/>



  /*return <div>
    <h1> Hallo </h1>
    <Greetings name = "Mathias" age="21"/>
    <Greetings name = "Ulli" age="41"/>
    <Greetings name = "Malte" age="31"/>
    <Greetings name = "Jonas" age="19"/>
    <Greetings name = "Layla" age="24"/>
  </div>*/
